        ...
        <div className="archive-cardgames-grid">
              ...
              <ol className="rules-list font-size-base">
                ...
                <li><strong className="rule-label">Valid Plays:</strong>
                  <ol>
                    ...
                    <li>Mirrored Sequence: 3+ consecutive pairs (e.g., 4♣4♦ 5♣5♦ 6♣6♦)</li>
                    <li>Four of a Kind: Four cards of same rank (e.g., 7♣ 7♦ 7♠ 7♥)</li>
                  </ol>
                </li><li><strong className="rule-label">2-Killers:</strong> Four of a Kind or Mirrored Sequence can defeat a 2</li>
                <li><strong className="rule-label">Special:</strong> 2's are strongest singles but can be beaten by 2-killers.</li>
                <li><strong className="rule-label">Winning:</strong> First to play all cards wins.</li>
              </ol>
            </div>
          </div>
          ...
          <div className="cardgame-section cardgame-box">
            ...
            <div className="game-rules">
              ...
              <ol className="rules-list font-size-base">
                <li><strong className="round-label">Round 1 – Guessing Round:</strong> Each player gets 4 face-down cards. For each card, guess if it is:
                  <ol>
                    <li>Red or Black?</li>
                ...
                <li><strong className="round-label">Round 2 – The Pyramid:</strong>
                  ...
                  <span className="mono">The player(s) with the most matches at the end → becomes the Busfahrer and goes to the desert.</span>
                </li>                <li><strong className="round-label">Round 3 – Survive the desert:</strong>
                  <ol>
                    <li>The Busfahrer(s) repeat Round 1.</li>
                    <li>They must guess each card in sequence (Red/Black, Higher/Lower, Inside/Outside, Same/Differnt Suit).</li>
                    <li><strong>If they get ANY guess wrong at ANY stage → they drink and start over completely!</strong></li>
